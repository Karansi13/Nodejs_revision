const classroom = [
    ...
    },
    {
      ...
      city: "San Francisco",
      age: 22,
      skills: ["C++", "Cybersecurity", "Data Analysis"],
    ...
    },
    {
      ...
      city: "Portland",
      age: 21,
      skills: ["JavaScript", "Angular", "Vue.js"],
    ...
    },
    {
      ...
      city: "Houston",
      age: 21,
      skills: ["Kotlin", "Android Development", "Flutter"],
    ...
    },
    {
      ...
      city: "San Antonio",
      age: 20,
      skills: ["C", "Linux", "Shell Scripting"],
    ...
    },
    {
      ...
      city: "Cleveland",
      age: 21,
      skills: ["Java", "Scala", "Akka"],
      email: "cindy.phillips@example.com",
    },
    {
      name: "Derek Ramirez",
      branch: "CSE",
      ...
      email: "derek.ramirez@example.com",
    },
    {
      name: "Elena Turner",
      branch: "CSE",
      ...
      email: "elena.turner@example.com",
    },
    {
      name: "Finn Brooks",
      branch: "CSE",
    ...
    },
    {
      ...
      email: "harry.rogers@example.com",
    },
    {
      name: "Isla Peterson",
      branch: "CSE",
      ...
      email: "isla.peterson@example.com",
    },
    {
      name: "Jake Reed",
      branch: "CSE",
    ...
    },
    {
      ...
      city: "El Paso",
      age: 22,
      skills: ["PHP", "Drupal", "WordPress"],
      email: "liam.butler@example.com",
    },
    {
      name: "Maya Gonzalez",
      branch: "CSE",
...
//   const studentsAbove18 = [];
  
  // for (let i = 0; i < classroom.length; i++) {
    //   if (classroom[i].age >= 21) {
        //     studentsAbove18.push(classroom[i]);
        //     console.log(studentsAbove18.length)
        //   }
        // }
        
        // classroom.forEach((student, i) => {
        //     if (student.age >= 21) {
        ...
        // while(0 < classroom.length){
            //     if(classroom[0].age > 21){
                //         studentsAbove18.push(classroom.shift());
...
// filter has its own array
// const studentsAbove18 = classroom.filter(student => student.name[0] >= 21);
// console.log(studentsAbove18);
// console.log(studentsAbove18.length);

// select those students whose name starts with A, B or C with for loop
// const array = [];
// for(let i = 0; i < classroom.length; i++){
//     if(classroom[i].name[0] === 'A' || classroom[i].name[0] === 'B' || classroom[i].name[0] === 'C'){
//         array.push(classroom[i]);
//     }
//     console.log(array.length);
// }

// const students = classroom.filter((student ) => {
//     return student.name[0] === 'A' || student.name[0] === 'B' || student.name[0] === 'C';
// })
...
const names = classroom.map((student, index) => student.name);
console.log(names);

const ages = classroom.map(student => student.age);
console.log(ages);


// use reduce method

const totalAge = classroom.reduce((total, student) => total + student.age, 0);
console.log(totalAge);

const averageAge = totalAge / classroom.length;
console.log(Math.floor(averageAge));

// use find method

const firstStudent = classroom.find(student => student.age === 20);
console.log(firstStudent);

// use every method

const allStudentsAbove20 = classroom.every(student => student.age > 20);
